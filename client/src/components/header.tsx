    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/10">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Link to="/">
          <div className="flex items-center space-x-2 cursor-pointer group">
            <div className="transition-transform group-hover:scale-105">
              <ArbFlowLogo size={60} showGlow={true} />
            </div>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link to="/documentation">
            <div className="relative text-foreground font-medium transition-all duration-200 ease-in-out group cursor-pointer">
              About
